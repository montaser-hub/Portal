...
// //             </div>
// //           </div>
// //           <Text as="h1" content="Reset Password" MyClass="text-2xl font-semibold text-[#0F7B8A] mt-4" />
// //           <Text as="p" content={`Enter a new password for ${email || "your account"}`} MyClass="text-sm text-gray-500 mt-2" />
// //         </div>
...
// //             <button
// //               type="submit"
// //               disabled={!password || !confirm || !!errors.password || !!errors.confirm}
// //               className={`w-full h-11 mt-4 flex items-center justify-center bg-[#0F7B8A] text-white rounded-lg shadow-md hover:bg-[#0D6C78] ${
// //                 !password || !confirm || !!errors.password || !!errors.confirm ? "opacity-60 cursor-not-allowed" : ""
// //               }`}
// //             >
// //               Reset Password
// //             </button>
...
// //               <Link to="/Login" className="text-[#0F7B8A] hover:text-[#0D6C78]">Back to Sign In</Link>
// //             </div>
// //           </form>
// //         </Card>
// //       </div>
...
//     // تحقق من الكونفيرم بالنسبة للكلمة الجديدة
//     const confirmError = confirm.length > 0 && confirm !== value ? "Passwords do not match" : "";
